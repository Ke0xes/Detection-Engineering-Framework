...
| **DeTT&CT** | Data source and detection quality scoring | Data quality, coverage scoring | **Strongly aligned.** DeTT&CT's data quality dimensions informed [chapter 12](12-telemetry-and-data.md). Use DeTT&CT for the scoring; use this framework for the lifecycle around it |
...
clearest example is [chapter 9](09-metrics.md), which argues that the classical
false positive rate is unusable in detection engineering despite its widespread
citation.

---

*Next: [Worked Example](19-worked-example.md) · Previous: [Advanced Best Practices](17-best-practices.md)*
